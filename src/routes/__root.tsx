...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Gestiona tus personajes, equipamiento, inventario y campañas con un diseño medieval de fantasía." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Vamos a Rolear — Gestor D&D" },
      { name: "twitter:description", content: "Gestiona tus personajes, equipamiento, inventario y campañas con un diseño medieval de fantasía." },
